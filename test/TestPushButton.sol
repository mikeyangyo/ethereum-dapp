...
contract TestPushButton {
  ...
  function testInitialUsingDeployedContract() public {
    ...
    function testUserCanPush() public {
    ...
    function testUserCannotPushAfterTimeout() public {
    PushButtonMock pbmk = new PushButtonMock();
    pbmk.setMockedBlockNumber(pb.nextTimeoutBlock() + 1);
